...
export default async function loadStellarBalance(                                                                  
  accountId: string                                                                                                
): Promise<StellarBalanceResult> {                                                                                 
  ...
  if (                                                                                                             
    ...
    throw new Error(                                                                                               
      `Freighter network mismatch. Freighter: ${freighterPassphrase}, App: ${STELLAR_NETWORK_PASSPHRASE}`          
    );                                                                                                             
  }                                                                                                                
